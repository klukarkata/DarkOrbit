...
<?php include("includes/variables.php"); ?>
    ...
    <script type="text/javascript">
        ...
        var dock = window.location.search;


        if(dock.indexOf("rsucces") != -1) {
            alert("Ship repare");
        } else if (dock.indexOf("rfail") != -1) {
            alert("Error");
        ...
        function repare() {
            ...
            var seo = "indexInternal.es?action=internalreparing"
            location.href = seo;
        ...
        <div id="overview_container" class="overview_image">
            ...
            <div id="overview_background">
                <div id="overview_content">
                    ...
                    <?php
                           if ( number_format($row_Cuenta['hp'], 0, ",", ".") <= 0 ) 
                                echo "<div id='repair_ship' onclick='repare()'><span id='txtR'>Repair<br /></span><span id='txtR2'>Free</span></div>";
